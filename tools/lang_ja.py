...
META = {
    ...
    # 分享卡片：首页和条款页说的不是同一件事，分开写
    "og_title_index": 'クオンツのコピートレード、負けた分は現金で返します — Presight',
    "og_desc_index": '戦略は自己資金で実運用。約定はすべて公開し、負けトレードも伏せません。規約どおり 1 か月コピーして期間全体が負けなら、その損失を現金で返金します。',
    "og_title_prot": 'コピートレード損失補償 · プログラム規約 — Presight',
    "og_desc_prot": '規約どおり 1 か月コピーして、コピー期間全体が負けで終われば、その損失を現金で返金。口座の届出、保護期間、基準資金、補償額の計算、除外事由、確認手続きの全文。',
    "og_image_alt": 'Presight — クオンツのコピートレードと損失補償',
...
INDEX.update({
    'A full month of copying from the moment you report your MT5 account ID in the community, with no manual intervention and no withdrawals in that first month; <b>after that, withdrawals are unrestricted — principal as well as profit</b>. If the whole copying period ends down — every deposit and withdrawal counted — the shortfall is refunded in <b>USD cash</b> within 10 business days of verification. Losses on positions you closed by hand are not covered.':
        'コミュニティで MT5 口座 ID を届け出た時点から<b>まる 1 か月</b>コピーを継続し、その最初の 1 か月は手動介入も出金もしません。<b>1 か月を過ぎたあとは出金に制限はありません——元本も利益も引き出せます。</b>コピー期間全体（入金・出金はすべて算入）が負けで終わった場合、その差額を<b>米ドル現金</b>で、確認完了から 10 営業日以内にお返しします。ご自身で手仕舞いした分の損失は補償の対象外です。',
...
PROTECTION.update({
    ...
    'Open an account with the partner platform through a Presight link, subscribe to PRESIGHT ALPHA-1 at a <b>1:1 copy ratio</b>, <b>report your MT5 account ID</b> to <span class="mono">@PresightAdminBot</span> on Telegram once copying has started, and keep copying for <b>a full month</b> with no manual intervention and no withdrawals in that first month. <b>After the first month, withdrawals are unrestricted — principal as well as profit, whenever you like — with no effect on eligibility.</b> If the whole copying period ends down, we refund the loss in <b>cash</b>.':
        'Presight のリンクから提携ブローカーに口座を開設し、<b>1:1 のコピー比率</b>で PRESIGHT ALPHA-1 を購読、コピーが始まったら Telegram の <span class="mono">@PresightAdminBot</span> に<b>MT5 口座 ID を届け出て</b>、<b>まる 1 か月</b>コピーを続けます。その最初の 1 か月は手動介入も出金もしません。<b>1 か月を過ぎたあとは出金に制限はありません——元本も利益も、いつ引き出しても資格に影響しません。</b>コピー期間全体が負けで終わった場合、その損失を<b>現金</b>でお返しします。',
    ...
    '<b>No withdrawals in the first month</b> (the 30 calendar days from your report). After that, withdrawals are unrestricted — you can take out principal as well as profit — with no effect on eligibility — every deposit and withdrawal simply counts towards the net result, see section 06.':
        '<b>最初の 1 か月（届出から 30 暦日）は出金しないこと。</b>それを過ぎれば出金に制限はなく、元本も利益もいつでも引き出せて、資格には影響しません——入出金はすべて純損益の計算に算入されるだけです（第 06 条）。',
    ...
    '<b>No effect on eligibility</b> — withdrawals are unrestricted, principal as well as profit. Every deposit and withdrawal feeds into the net result under section 06: withdrawing neither reduces your payout nor lets you bank profits and then claim on a later loss':
        '<b>資格には影響しません</b>——出金に制限はなく、元本も利益も引き出せます。入出金はすべて第 06 条の純損益に算入されます。出金によって補償が減ることはなく、利益を確定させてから後の損失で請求する、ということもできません',
